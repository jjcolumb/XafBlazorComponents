...
{
    public class BlazorCriteriaAdapter : ComponentAdapterBase
    {
        public BlazorCriteriaAdapter(BlazorCriteriaModel componentModel)
        {
            ComponentModel = componentModel ?? throw new ArgumentNullException(nameof(componentModel));
            ComponentModel.ValueChanged += ComponentModel_ValueChanged;
        }
        public BlazorCriteriaModel ComponentModel { get; }
        ...
        {
            return ComponentModelObserver.Create(ComponentModel, BlazorCriteriaRenderer.Create(ComponentModel));
        }
